...
//    @Test(dependsOnGroups = "loginTrue",description = "删除用户")
    ...
    private int getResult(UpdateUserInfoCase updateUserInfoCase) throws IOException {
        ...
        System.out.println("[start] --- 向moco请求的数据");
        System.out.println("param: " + param);
        System.out.println("uri: " + TestConfig.updateUserInfoUrl);
        System.out.println("method: POST");
        System.out.println("[ end ] --- 向moco请求的数据");
        //执行post方法
        ...
        System.out.println("[start] updateUserInfo---moco接口返回数据");


        System.out.println(response.getStatusLine());
        System.out.println(result);
        System.out.println("[end ] updateUserInfo---moco接口返回数据");
